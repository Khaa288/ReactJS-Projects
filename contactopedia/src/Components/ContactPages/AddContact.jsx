...
class AddContact extends React.Component {
    ...
    handleAddContactFormSubmit = (e) => {
        ...
        const phone = e.target.contactPhone.value.trim();
        const id = e.target.contactId.value.trim();
            ...
            <div className="border col-12 text-white p-2">
                <form onSubmit={this.handleAddContactFormSubmit} className="contact-form">
                    ...
                    <div className="row p-2">
                        ...
                        {this.state.errorMessage === undefined ? <div></div> : <div className="col-12 text-danger text-center">{this.state.errorMessage}</div>}
                        
                        {this.state.successMessage === undefined ? <div></div> : <div className="col-12 text-success text-center">{this.state.successMessage}</div>}
                        ...
                        <div className= "col-12 p-1 col-md-4 p-1">
                            {
